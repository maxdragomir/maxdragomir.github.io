var w = dotty.width = window.innerWidth,
    ...
    opts = {
      ...
      // colors: [ 'rgba(255,29,77,alp)', 'rgba(0,200,170,alp)', 'rgba(255,255,255,alp)', 'rgba(78,117,157,alp)', 'rgba(0,172,237,alp)' ],

      colors: ['rgba(9,8,10,alp)', 'rgba(138,24,26,alp)', 'rgba(90,24,28,alp)'],

      addedAlpha: 20,
      strokeColor: 'rgb(9,8,10)',
...
function loop(){
  ...
  ctx.shadowBlur = 0;
  ctx.fillStyle = 'rgba(37,15,18,alp)'.replace( 'alp', opts.repaintAlpha );
