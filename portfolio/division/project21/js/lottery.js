...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var app = new Vue({
    ...
    methods: {
      ...
      step1Button: function step1Button() {
        this.checkPhone();
      ...
      step2Button: function step2Button() {
        this.checkConfirm();
      ...
      changePhone: function changePhone() {
        if (!this.error && this.error !== null) {
          ...
          this.step1 = true;
          this.step2 = false;
          this.deskStep2 = false;
          this.deskStep1 = true;
        }
      },
      deskStep1Button: function deskStep1Button() {
        this.checkPhone();
        this.checkCheckbox();
        ...
        if (!this.phoneError && !this.checkboxError) {
          this.deskStep1 = false;
          this.deskStep2 = true;
        }
      },
      deskStep2Button: function deskStep2Button() {
        if (!this.confirmError) {
          this.step2 = false;
          this.step3 = true;
        }
      ...
      checkConfirm: function checkConfirm() {
        this.confirmError = !this.confirm;
      },
      checkCheckbox: function checkCheckbox() {
        this.checkboxError = !this.checkbox;
      },
      checkAllFields: function checkAllFields() {
        this.checkPhone();
        this.checkConfirm();
        this.checkCheckbox();
        this.error = this.phoneError || this.confirmError || this.checkboxError;

        if (!this.error) {
          this.btnText = 'Готово';
          this.buttonSendCode = false;
        }
      },
      // input
      inputPhoneChange: function inputPhoneChange(value) {
        this.buttonSendCode = value.length > 0;
      },
      // helpers
